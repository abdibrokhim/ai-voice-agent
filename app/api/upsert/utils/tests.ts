...
export async function processMarkdownFile(filePath: string, fileId: string, indexName: string): Promise<void> {
    ...
    const pinecone = new Pinecone({
        apiKey: '', // Replace with your Pinecone API key
    });
...
// async function main() {
//     try {
//         await processMarkdownFile('./resources/interactive-demos-for-customer-success.md', 'unique-file-id');
//         console.log('Successfully processed and upserted Markdown file to Pinecone.');
//     } catch (error) {
